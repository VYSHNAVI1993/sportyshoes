...
public class UserLogin extends HttpServlet {
	...
	private final String admin = "Vysh Ghanta";
	private final String pass = "vyshnavireddyghanta@gmail.com";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (username.equals(admin) && password.equals(pass)) {
			...
			if (flag1 == true) {
				...
				out.println("<font color=red><br><br><h1>User Password is wrong!</h1></font>");
